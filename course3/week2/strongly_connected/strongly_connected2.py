...
def DepthFirstSearchUpdateNodes(adj, startPoint, allNodes, nodeVals, explored):
    ...
    while neighborhoodlocal:
        ...
        explored.update(DepthFirstSearchUpdateNodes(adj, nextNode, allNodes,
                        nodeVals, explored))
